...
static void MSC_TestChamber_goto_s0(void)
{
    goto_s0 = true;
    puts("MSC goto s0");
}
static void MSC_TestChamber_goto_s1(void)
{
    goto_s1 = true;
    puts("MSC goto s1");
}
static void MSC_TestChamber_goto_s2(void)
{
    goto_s2 = true;
    puts("MSC goto s2");
}
static void MSC_TestChamber_goto_s3(void)
{
    goto_s3 = true;
    puts("MSC goto s3");
}
static void MSC_TestChamber_goto_l0(void)
{
    goto_l0 = true;
    puts("MSC goto l0");
}
static void MSC_TestChamber_goto_l1(void)
{
    goto_l1 = true;
    puts("MSC goto l1");
}
static void MSC_TestChamber_activate(void)
{
    activate = true;
    puts("MSC activate");
}
static void MSC_TestChamber_deactivate(void)
{
    deactivate = true;
    puts("MSC deactivate");
}
void MSC_TestChamber(void)
{
